...
const PER_STRING_ALLOWLIST: Array<{ file: string; text: string; reason: string }> = [
  ...
  { file: "src/components/landing/CTASection.tsx", text: "Free to open, protected from the very first sale.", reason: "Closing CTA from the hero-ambition pass (#55): the protection claim is the same escrow checkout, active from a store's first transaction." },
  ...
  { file: "src/pages/Pricing.tsx", text: "Open your store, list your products and share your link for free. You pay only when a deal completes, and upgrade only when you want more room to grow.", reason: "Plan pricing explainer, scoped by the free-scoping pass (#57): the free claim covers only the actions that cost nothing, and the next sentence states when the vendor pays." },
  ...
  { file: "src/components/landing/VerifiedSellersSection.tsx", text: "Your own store link, free to open. No listing fees, no setup fees: you pay only when a deal completes.", reason: "Landing seller pitch, scoped by the free-scoping pass (#57): free is scoped to opening, and the cost is stated as the success fee the fee card prices." },
