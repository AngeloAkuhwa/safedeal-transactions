...
const PER_STRING_ALLOWLIST: Array<{ file: string; text: string; reason: string }> = [
  ...
  { file: "src/pages/Pricing.tsx", text: "Open your store, list your products and take protected payments at no cost. Upgrade only when you want more room to grow.", reason: "Plan pricing explainer, reworded by the product-voice pass (#54): the protection claim is the same paid-checkout protection the fee table already describes." },
  ...
  { file: "src/components/landing/VerifiedSellersSection.tsx", text: "Your own store link, free forever. No listing fees, no setup fees: just protected payments.", reason: "Landing seller pitch, reworded by the product-voice pass (#54); the protection claim names the escrow checkout every store sale routes through." },
