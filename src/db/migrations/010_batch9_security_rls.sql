...
-- ============================================================
-- Applied via 2 migrations:
--   1. Main: sequence, 4 functions, ~70 RLS policies, delete prevention triggers, 3 views
--   2. Fix: Set views to SECURITY INVOKER

-- ======================== SEQUENCE ===========================
CREATE SEQUENCE IF NOT EXISTS public.transaction_code_seq START 1;

-- ============================================================
-- Part 1 — Security Helper Functions (4)
-- ============================================================
...
-- ============================================================
-- Part 2 — RLS Policies (~70 policies across 35 tables)
-- ============================================================
...
-- TRANSACTION_EVENTS (read-only for parties)
...
-- TRANSACTION_STATUS_HISTORY (read-only for parties)
...
-- MONEY_STATUS_HISTORY (read-only for parties)
...
-- TRANSACTION_AGREEMENT_SNAPSHOTS (read-only for parties)
...
-- DELIVERY_CONFIRMATIONS (read-only for parties)
...
-- ESCROW_LEDGER_ENTRIES (read-only)
...
-- PAYOUTS (read-only, seller sees own)
...
-- REFUNDS (read-only, buyer sees own)
...
-- DISPUTE_STATUS_HISTORY (read-only)
...
-- NOTIFICATION_DELIVERIES (admin read-only)
...
-- USER_REGION_ACCESS_LOGS (admin read-only)
...
-- ============================================================
-- Part 3 — Delete Prevention Triggers
-- ============================================================
...
-- ============================================================
-- Part 4 — Performance Views (SECURITY INVOKER)
-- ============================================================
