                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex flex-wrap items-center gap-2">
                              ...
                              {typeof alert.count === "number" && alert.count > 1 && (
                                <span className={`inline-flex items-center justify-center rounded-full px-2 py-0.5 text-[10px] font-bold ${c.countBadge}`}>
                                  {alert.count}
                                </span>
                              )}
                              {dueChip && (
                                <span className={`inline-flex items-center rounded-full px-2 py-0.5 text-[10px] font-medium ${c.dueChip}`}>
                                  {dueChip}
                                </span>
                              )}
                            </div>
