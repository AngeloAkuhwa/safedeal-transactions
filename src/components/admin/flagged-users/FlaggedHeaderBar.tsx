    ...
    <header className="sticky top-0 z-sticky hidden border-b border-slate-800 bg-slate-900/95 backdrop-blur px-4 py-5 md:px-8 lg:block">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button type="button" onClick={onRefresh} disabled={isFetching} className={`px-4 py-2 ${ADMIN_SOLID.danger} rounded-lg transition-all flex items-center gap-2 text-sm font-medium disabled:opacity-60 min-h-11`}>
