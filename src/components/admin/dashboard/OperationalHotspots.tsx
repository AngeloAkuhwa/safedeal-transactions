        ...
        return (
          ...
          >
            ...
            <button
              ...
              className={`mt-2 inline-flex w-full items-center justify-center rounded-md px-2.5 py-1.5 text-[11px] font-medium transition-colors ${SEVERITY_BTN[item.severity]} min-h-11`}
            >
              {item.action_label}
            </button>
          </div>
