              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center justify-between gap-2 mt-3">
                  ...
                  <div className="text-right min-w-0">
                    ...
                    {verified ? (
                      <span className="inline-flex items-center gap-1 px-1.5 py-0.5 bg-emerald-500/20 border border-emerald-500/30 text-emerald-400 rounded text-xs font-bold">VERIFIED</span>
                    ) : (
                      <span className="inline-flex items-center gap-1 px-1.5 py-0.5 bg-red-500/20 border border-red-500/30 text-red-400 rounded text-xs font-bold">UNVERIFIED</span>
                    )}
                  </div>
                </div>
