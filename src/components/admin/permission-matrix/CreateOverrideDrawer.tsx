      ...
      <SheetContent side="right" className="w-full overflow-y-auto sm:max-w-xl">
        ...
        <div className="mt-4 space-y-4 text-sm">
          ...
          <section className="space-y-2">
            <div className="text-[11px] uppercase text-muted-foreground">User</div>
            ...
            <div className="max-h-40 overflow-y-auto rounded-md border border-border/60">
              {users.map((u) => (
                <button type="button" key={u.id} onClick={() => setUser(u)}
                  ...
                  <span className="rounded-full border border-border bg-background px-2 py-0.5 text-[10px] text-muted-foreground">{u.role ? ROLE_LABEL[u.role] : "no role"}</span>
                </button>
              ))}
              {users.length === 0 && <div className="px-2 py-2 text-[11px] text-muted-foreground">No matches</div>}
            </div>
          </section>

          {/* Permission picker */}
          <section className="space-y-2">
            <div className="text-[11px] uppercase text-muted-foreground">Permission</div>
            <div className="flex items-center gap-2 rounded-md border border-border bg-background px-2">
              <Search className="h-3 w-3 text-muted-foreground" />
          ...
          {/* Type */}
          <section className="space-y-2">
            <div className="text-[11px] uppercase text-muted-foreground">Override type</div>
          ...
          <section className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            <label className="block sm:col-span-2">
              <span className="mb-1 block text-[11px] uppercase text-muted-foreground">Reason (min 20 chars)</span>
              ...
              <div className="mt-1 text-[10px] text-muted-foreground">{reason.trim().length}/20</div>
            </label>
            <label className="block sm:col-span-2">
              <span className="mb-1 flex items-center gap-1 text-[11px] uppercase text-muted-foreground">
          ...
          <section className="space-y-2 rounded-md border border-border/60 bg-background/40 p-3">
            <div className="text-[11px] uppercase text-muted-foreground">Impact preview</div>
