        ...
        <div className="space-y-3 text-sm">
          <div className="grid grid-cols-2 gap-3">
            <label className="block">
              <span className="mb-1 block text-xs uppercase text-muted-foreground">Module</span>
            ...
            <label className="block">
              <span className="mb-1 block text-xs uppercase text-muted-foreground">Action</span>
          ...
          <div className="flex items-center gap-2 rounded-md border border-border/60 bg-muted/30 px-2 py-1 font-mono text-xs text-muted-foreground">
            ...
            {!!editing && <span className="ml-auto text-xs italic">Key is immutable after creation</span>}
          </div>
          <label className="block">
          ...
          <div className="grid grid-cols-2 gap-3">
            <label className="block">
              <span className="mb-1 block text-xs uppercase text-muted-foreground">Risk</span>
            ...
            <label className="block">
              <span className="mb-1 block text-xs uppercase text-muted-foreground">Owner role</span>
          ...
          <div className="grid grid-cols-2 gap-3">
            <label className="flex items-center gap-2 text-sm">
              <input type="checkbox" checked={approvalRequired} onChange={(e) => setApprovalRequired(e.target.checked)} className="h-5 w-5 relative before:absolute before:-inset-3 before:content-['']" />
              Approval required
            </label>
            {editing && (
              <label className="block">
          ...
          <div>
            <div className="mb-1 text-xs uppercase text-muted-foreground">Environments</div>
      ...
      <div className="mt-1 max-h-32 overflow-y-auto rounded-md border border-border/60 bg-background/50">
        {filtered.map((p) => (
          <button
            ...
            className={`flex w-full items-center gap-2 px-2 py-1 text-left text-xs hover:bg-muted ${value.includes(p.key) ? "bg-primary/5" : ""} min-h-11`}
          >
