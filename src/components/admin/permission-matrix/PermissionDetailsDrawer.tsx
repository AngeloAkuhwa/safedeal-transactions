        ...
        {override && (
          <div className="mt-4 space-y-3 text-sm">
            ...
            <div>
              ...
              <div className="font-mono text-xs text-muted-foreground">{override.permission_key}</div>
            </div>
            <div>
            ...
            {canEdit && environment && (
              <div className="space-y-3 rounded-md border border-border/60 bg-background/40 p-3">
                <div className="text-xs font-semibold uppercase text-muted-foreground">Manage</div>
                ...
                <div>
                  <span className="mb-1 block text-xs uppercase text-muted-foreground">Revoke reason</span>
