  ...
  return (
    <li className={cn("flex items-center gap-2 rounded-md border px-2 py-1.5 text-xs", shell, staged && "ring-1 ring-primary/50")}>
      ...
      <span className="ml-auto flex items-center gap-1.5">
        ...
        {staged && (
          <span className={cn(
            "inline-flex items-center rounded-full px-1.5 py-0.5 text-xs font-semibold uppercase",
        ...
        <button
          ...
          className={cn(
            "inline-flex h-11 min-w-11 items-center justify-center gap-0.5 rounded-full border px-1.5 text-xs font-semibold transition",
