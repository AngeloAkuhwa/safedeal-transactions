          ...
          {task && !isBulk && (
            <div className="rounded-xl border border-border/60 bg-card/40 p-3 text-sm">
              <div className="mb-1 flex flex-wrap items-center gap-2">
                ...
                {requiredRole && (
                  <span className="inline-flex rounded-full bg-sky-500/10 px-2 py-0.5 text-[10px] font-semibold text-sky-300 ring-1 ring-inset ring-sky-500/30">
                    needs {humanize(requiredRole)}
                  </span>
                )}
                {isFinancial && (
                  <span className="inline-flex items-center gap-1 rounded-full bg-amber-500/10 px-2 py-0.5 text-[10px] font-semibold text-amber-300 ring-1 ring-inset ring-amber-500/30">
                  ...
                  >
                    <div className="flex items-start justify-between gap-2">
                      <div className="flex min-w-0 items-center gap-2">
                        <div className="relative flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-muted text-[10px] font-semibold">
                          {a.avatar_url
