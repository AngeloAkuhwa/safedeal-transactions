        ...
        <div className="flex min-w-0 items-center gap-2">
          ...
          <div className="min-w-0">
            ...
            <div className="flex items-center gap-1.5 text-xs">
              ...
              {!eligible && !offline && (
                <span className="rounded-full bg-muted/60 px-1.5 py-0 text-xs uppercase tracking-wider text-muted-foreground">
                  Ineligible
                </span>
              )}
            </div>
        ...
        <div className="flex items-center gap-1">
          {(agent.critical_active ?? 0) > 0 && (
            <span
              ...
              className="inline-flex items-center gap-0.5 rounded-full bg-rose-500/10 px-1.5 py-0.5 text-xs font-semibold text-rose-300 ring-1 ring-inset ring-rose-500/30"
            >
          ...
          {agent.sla_risk && agent.sla_risk !== "low" && (
            <span
              ...
              className={cn("inline-flex items-center gap-0.5 rounded-full px-1.5 py-0.5 text-xs font-semibold ring-1 ring-inset", slaTone)}
            >
