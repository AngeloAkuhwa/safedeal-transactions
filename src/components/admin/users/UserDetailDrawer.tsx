          ...
          <div className="p-5 space-y-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-slate-900 border border-slate-800 rounded-lg p-3">
                ...
                {data.user.verification.email && <span className="text-emerald-400 text-[10px]">verified</span>}
              </div>
              <div className="bg-slate-900 border border-slate-800 rounded-lg p-3">
                ...
                {data.user.verification.phone && <span className="text-emerald-400 text-[10px]">verified</span>}
              </div>
              <div className="bg-slate-900 border border-slate-800 rounded-lg p-3">
