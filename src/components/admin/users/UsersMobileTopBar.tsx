      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <button
            type="button"
            onClick={onOpenMenu}
            className="w-11 h-11 min-w-11 shrink-0 flex items-center justify-center bg-slate-800 rounded-lg text-slate-300 active:scale-95 transition-transform"
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="w-11 h-11 min-w-11 shrink-0 flex items-center justify-center bg-slate-800 rounded-lg text-slate-300 active:scale-95"
            aria-label="Search"
          >
