                ...
                >
                  <td className="p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-slate-500 text-xs mt-1">{r.display_id}</p>
                      </div>
                    </div>
                  </td>
                  <td className="p-4">
                  ...
                  <td className="p-4">
                    <div role="button" tabIndex={0} onKeyDown={keyActivate} className="flex items-center justify-end gap-1.5" onClick={(e) => e.stopPropagation()}>
                      <button title="Quick preview" onClick={(e) => { e.stopPropagation(); onOpenDetail(r.user_id); }} className="px-2.5 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded text-xs min-h-11 min-w-11 inline-flex items-center justify-center"><UserIcon className="h-3.5 w-3.5" /></button>
                      <button title="Transactions" onClick={(e) => { e.stopPropagation(); navigate(`/admin/transactions?q=${r.user_id}`); }} className="px-2.5 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded text-xs min-h-11 min-w-11 inline-flex items-center justify-center"><ArrowLeftRight className="h-3.5 w-3.5" /></button>
                      ...
                      <button title="Start Impersonation" onClick={(e) => { e.stopPropagation(); toast({ title: "Impersonation coming soon" }); }} className="px-2.5 py-1.5 bg-purple-600 hover:bg-purple-700 text-white rounded text-xs min-h-11 min-w-11 inline-flex items-center justify-center"><UserCog className="h-3.5 w-3.5" /></button>
