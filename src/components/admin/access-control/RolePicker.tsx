              ...
              <div className="flex items-start gap-2">
                <button
                  ...
                  className={`mt-0.5 flex h-4 w-4 shrink-0 items-center justify-center rounded border ${
                    selected ? "border-blue-500 bg-blue-600 text-white" : "border-border bg-background"
                  }`}
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    {selected && (
                      <button
                        ...
                        className={`ml-auto rounded p-0.5 ${isPrimary ? "text-amber-400" : "text-muted-foreground hover:text-amber-400"}`}
                      >
