          ...
          <div className="min-w-0">
            ...
            <div className="mt-1 flex flex-wrap items-center gap-1.5">
              ...
              {user.two_factor_enabled ? (
                <span className="inline-flex items-center gap-1 rounded-md border border-emerald-500/40 bg-emerald-500/10 px-1.5 py-0.5 text-xs text-emerald-300">
                  <ShieldCheck className="h-3 w-3" /> 2FA on
                </span>
              ) : (
                <span className="inline-flex items-center gap-1 rounded-md border border-amber-500/40 bg-amber-500/10 px-1.5 py-0.5 text-xs text-amber-300">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-1.5">
                ...
                {user.permissions.map((p) => (
                  <span key={p} className="rounded-md border border-border bg-muted/60 px-2 py-0.5 text-xs font-mono text-foreground/80">
                    {p}
                  </span>
                ))}
              </div>
