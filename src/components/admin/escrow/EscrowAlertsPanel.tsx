        ...
        <div className="mt-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 p-4 bg-slate-800/30 border border-slate-700 rounded-lg">
          ...
          {canConfigure ? (
            <button
              ...
              className="px-4 py-2 bg-sky-600 hover:bg-sky-700 text-white rounded-lg text-sm font-medium inline-flex items-center gap-2 shrink-0 transition-colors min-h-11"
            >
