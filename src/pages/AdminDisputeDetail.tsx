          ...
          <div className="px-6 py-6 lg:px-8 lg:py-8 space-y-8">
            ...
            <Card>
              ...
              <div className="p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <LinkedTile tone="red" icon={<Flag className="h-5 w-5" />} title="Buyer in Flagged Users"
                ...
                <LinkedTile tone="red" icon={<Flag className="h-5 w-5" />} title="Seller in Flagged Users"
