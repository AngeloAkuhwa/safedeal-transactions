          ...
          <div className="flex min-w-0 items-center gap-4">
            ...
            {heroImage && (
              <div className="hidden sm:block w-10 h-10 rounded-lg border border-border overflow-hidden bg-muted">
                <ProductImage url={heroImage.file_url} alt="" rendition="thumb" sizes="64px" />
              </div>
            )}
                          ...
                          {thumbnails.map((m: any) => (
                            <div key={m.id} className="aspect-square rounded-lg border border-border overflow-hidden bg-muted">
                              {m.media_type === "video" ? (
                                ...
                                <ProductImage url={m.file_url} alt="" rendition="thumb" sizes="(max-width: 640px) 25vw, 120px" />
                              )}
                            </div>
                          ))}
                        </div>
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className={`text-xs font-semibold px-2 py-0.5 rounded-full border ${stockBadgeClass}`}>
                        {stockLabel}
                      </span>
                    </div>
                  </div>
