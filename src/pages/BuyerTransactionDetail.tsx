...
const BuyerTransactionDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 mx-auto max-w-4xl w-full px-4 sm:px-6 py-6 space-y-6">
        ...
        {/* ── Next Action Card (full-width gradient) ── */}
        {next_action && (
          <div className="rounded-2xl bg-gradient-to-br from-warning to-warning/80 p-6 text-warning-foreground shadow-lg">
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                <h2 className="text-lg font-bold">{next_action.label}</h2>
                <p className="text-sm opacity-80 mt-0.5">{next_action.description}</p>
              </div>
            </div>
            ...
            <div className="space-y-2">
              {tx.status === "delivered_awaiting_verification" && (
                <>
                  <Button
                    className="w-full bg-white/20 hover:bg-white/30 text-warning-foreground border border-white/30 font-bold h-11"
                  ...
                  <Button
                    variant="outline"
                    className="w-full bg-transparent hover:bg-white/10 text-warning-foreground border border-white/30 font-semibold h-11"
                    onClick={() => navigate(`/dashboard/transactions/${tx.id}/verify`)}
                  >
            ...
            {tx.status === "delivered_awaiting_verification" && (
              <div className="mt-5 pt-4 border-t border-white/20">
                <p className="text-xs font-semibold opacity-80 mb-2">Other Actions</p>
                <div className="space-y-1">
                  <button className="w-full flex items-center gap-2 text-sm opacity-80 hover:opacity-100 py-1.5 transition-opacity">
...
/* ───── Timeline Component (card-row style) ───── */
        ...
        return (
          ...
          >
            ...
            <div className={`h-8 w-8 rounded-full flex items-center justify-center shrink-0 ${
              isReached ? "bg-success text-success-foreground" :
