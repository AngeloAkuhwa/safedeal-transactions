                ...
                rows.map((t, i) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-2.5 align-middle">
                      ...
                      />
                      <div className="mt-1 text-xs text-muted-foreground">{t.moneyStatus.label}</div>
                    </td>
                    <td className="px-3 py-2.5 align-middle">
                      {t.escrowStatus.key === "pending" || t.escrowStatus.key === "released" ? (
                        <span className="text-xs text-muted-foreground">{t.escrowStatus.label}</span>
                      ) : (
                        <Badge
                          ...
                          <div className="flex flex-wrap items-center gap-1">
                            ...
                            {overflow.length > 0 && (
                              <span
                                ...
                                className="inline-flex items-center rounded-md border border-border bg-muted px-1.5 py-0.5 text-xs font-semibold text-muted-foreground"
                              >
                                +{overflow.length}
                              </span>
                            )}
