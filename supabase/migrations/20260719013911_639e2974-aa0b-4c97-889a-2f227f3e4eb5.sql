...
DROP FUNCTION IF EXISTS public.admin_flagged_users_page(text,text,text,text,text,int,int);
...
RETURNS TABLE (
  ...
  admin_flag_count bigint, escrow_at_risk numeric, latest_tx_id uuid, latest_tx_code text,
  disputes_30d int, latest_dispute_id uuid, refunds_30d int, identity_rejected boolean,
  identity_reason text, has_open_investigation boolean, blocked_payouts bigint,
  reversed_payouts bigint, flagged_by_admin_id uuid, auto_detected boolean,
