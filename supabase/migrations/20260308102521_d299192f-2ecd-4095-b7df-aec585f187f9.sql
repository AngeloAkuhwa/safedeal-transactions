...
VALUES
  ('a1b2c3d4-0001-4000-8000-000000000001', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'buyer@samplestore.test', crypt('testpassword123', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"Tunde Adeyemi"}', now() - interval '30 days', now(), '', '', '', ''),
  ('a1b2c3d4-0002-4000-8000-000000000002', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'seller@samplestore.test', crypt('testpassword123', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"Chioma Okafor"}', now() - interval '30 days', now(), '', '', '', ''),
  ('a1b2c3d4-0003-4000-8000-000000000003', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'admin@safedeal.test', crypt('testpassword123', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"SafeDeal Admin"}', now() - interval '30 days', now(), '', '', '', '');
