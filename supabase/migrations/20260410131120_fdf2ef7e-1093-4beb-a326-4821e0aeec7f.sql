...
-- 3. Create phone_otp_codes table
...
-- No client-side RLS policies — service role only access
...
-- 4. Create compute_verification_level function
...
-- 5. Sync existing users' verification levels
